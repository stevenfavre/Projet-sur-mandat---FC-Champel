          ...
          <div class="col-md-15 col-xl-7">
            <div>
              <form action="creer_tournoi.php" method="post">
                ...
                <table>
                  <tbody<td>
                    <ul> <button class="btn btn-primary" type="submit" name="submit" value="ok">Créer</button>&nbsp&nbsp <a class="btn btn-primary shadow" role="button" href="afficher_tournois.php"><i class="fa-solid fa-arrow-left"></i></a>
                    </ul>
                    </td>
                </table>
              </form>
