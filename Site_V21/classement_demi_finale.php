...
<head>
  ...
  <title>Demi finale - Tournois</title>
                ...
                <div class="col-md-6 col-xl-4">
                  <div>
                    <div class="container">
                      ...
                      <?php
                      affichageResulatsDemiFinal($_SESSION['id_tournoi']);
                      ?>
              </tbody>
            </table>
          </form>
          <br /><br />
          <a class="btn btn-primary shadow" role="button" href="./functions/algorithme_finale_petite_finale.php?id_tournoi=<?php echo $_SESSION['id_tournoi'] ?>">Générer finale / petite finale</a>
</br></br>
