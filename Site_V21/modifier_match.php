...
if ($submitPost == 'modifier') {
    ...
    else if (empty($id_local)||empty($id_visiteur)||empty($time_debut)||empty($time_fin)||empty($type)||!isset($but_local)||!isset($but_visiteur))
        echo '<script type="text/javascript">alert("Les informations fournis ne sont pas correct !")</script>';
    else {
