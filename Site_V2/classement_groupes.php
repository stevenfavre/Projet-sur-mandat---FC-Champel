      ...
      <div class="container py-5">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-8 col-xl-6">
            ...
            <a class="btn btn-primary shadow" role="button" href="./functions/algorithme_quart_finale.php'<?php $_SESSION['id_tournoi'] ?>'">Générer les quarts de finale</a>

            <a class="btn btn-primary shadow" role="button" href="./functions/algorithme_match_9e_16e_place.php'<?php $_SESSION['id_tournoi'] ?>'">Générer les matchs pour la 9ème à la 16ème place</a>
          </div>
        </div>
      </div>
    </div>
