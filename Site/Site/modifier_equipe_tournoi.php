          ...
          <form action="modifier_equipe_tournoi.php" class="p-3 p-xl-4" method="post">
            ...
            <table>
              <tbody>
                ...
                <?php //afficher_infos_equipes_selectionnee(); 
                ?>
                <!-- afficher_infos_equipes_inscrites_modif()  -->
              </tbody>
            </table>
            <div class="row d-flex justify-content-center">
              <div class="col-md-6 col-xl-4">
                ...
                <br /><br />
                <a class="btn btn-primary shadow d-block w-100" role="button" href="afficher_equipe_tournoi.php">Modifier</a>
                <br /><br />
