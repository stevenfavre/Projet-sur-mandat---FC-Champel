    ...
    <div class="container bg-primary-gradient py-5">
      <div class="row">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
          ...
          <h3 class="fw-bold text-success mb-2">Modifier équipes inscrites</h3>
        </div>
      </div>
            ...
            <table>
              <tbody>
                <tr>
                  <td>
                    <ul>
                      <p class="fw-bold text-success mb-2">Choisissez l'inscription que vous souhaitez modifier</hp>
              ...
              <table>
                <tbody>
                  <tr>
                    <td>
                      <ul>
                        <h5 class="fw-bold card-title">Nom equipe</h5>
                      </ul>
                    </td>
