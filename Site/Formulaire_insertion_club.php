...
$FK_Id_Adresse = filter_input(INPUT_POST,  'FK_ID_Adresse');

if (!empty($nomClub) && !empty($urlImageClub) && !empty($FK_Id_Adresse)) {
    insertion_club($nomClub, $urlImageClub, $FK_Id_Adresse);
}
                ...
                <div class="col-md-6 col-xl-4">
                    <div>
                        <form action="#" class="p-3 p-xl-4" method="post">
                            ...
                            <div class="mb-3"><input class="form-control" type="text" id="FK_ID_Adresse" name="FK_ID_Adresse" placeholder="Cle étrangère de l'adresse club"></div>
                            <div><input class="btn btn-primary shadow d-block w-100" value='Envoyer' type="submit"></div>
                            <br /><br />
                            <a href="../Site/Formulaire_insertion_equipe.php">Insérer une équipe du club</a>
                            <br /><br />
