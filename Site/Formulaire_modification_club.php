...
if (!empty($idClub) && !empty($nomClub) && !empty($urlImageClub)) {
    modification_club($idClub, $nomClub, $urlImageClub);
}
                ...
                <div class="col-md-6 col-xl-4">
                    <div>
                        <form action="#" class="p-3 p-xl-4" method="post">
                            ...
                            <div class="mb-3"><input class="form-control" type="text" id="Url_Image_Club" name="Url_Image_Club" placeholder="Url de l'Image Club"></div>
                            <div><input class="btn btn-primary shadow d-block w-100" value='Envoyer' type="submit"></div>
                            <br /><br />
                            <a href="../Site/Formulaire_modification_equipe.php">Modifier une équipe du club</a>
                            <br /><br />
