...
$FK_ID_Club = filter_input(INPUT_POST,  'FK_ID_Club');
$FK_ID_Groupe = filter_input(INPUT_POST,  'FK_ID_Groupe');

if (!empty($Nom_Equipe) && !empty($Degres_Equipe) && !empty($FK_ID_Club) && !empty($FK_ID_Groupe)) {
    insertion_equipes($Nom_Equipe, $Degres_Equipe, $FK_ID_Club, $FK_ID_Groupe);
}
                ...
                <div class="col-md-6 col-xl-4">
                    <div>
                        <form action="#" class="p-3 p-xl-4" method="post">
                            ...
                            <div class="mb-3"><input class="form-control" type="text" id="FK_ID_Club" name="FK_ID_Club" placeholder="Cle étrangère club"></div>
                            <div class="mb-3"><input class="form-control" type="text" id="FK_ID_Groupe" name="FK_ID_Groupe" placeholder="Cle étrangère groupe"></div>
                            ...
                            <br /><br />
                            <a href="../Site/affichage_equipe_bdd.php">Afficher les équipes de notre base de données</a>
                        </form>
                    </div>
                </div>
