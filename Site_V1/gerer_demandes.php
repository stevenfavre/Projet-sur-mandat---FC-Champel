    ...
    <div class="container bg-primary-gradient py-5">
      <div class="row">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
          <h1 class="fw-bold text-success mb-2">Valider inscriptions</h1>
          <h2 class="fw-bold"></h2>
        </div>
      </div>
      ...
      <div class="card shadow-sm">
        <div class="card-body px-4 py-5 px-md-5">
          ...
          <form action="gerer_demandes.php" class="p-3 p-xl-4" method="post">
            <table>
              <tbody>
                <tr>
                  <td>
                    <ul>
                      <h3 class="fw-bold text-success mb-2">Equipes en attente</h3>
              ...
              <table>
                <tbody>
                  <tr>
                    <td>
                      <ul>
                        <div><button class="btn btn-primary" type="submit" name="submit" value="modifier">Valider inscription</button></div>
                        <br /><br />
                        <br /><br />
                        <div><button class="btn btn-primary" type="submit" name="submit" value="aff">Toutes les demandes</button></div>
                        <br /><br />
