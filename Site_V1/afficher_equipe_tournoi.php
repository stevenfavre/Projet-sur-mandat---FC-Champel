...
if ($_POST['submit'] == "choix") {
  $_SESSION['id_inscription'] = $_POST['FK_ID_Equipe'];
}


$_SESSION['id_tournoi_inscription'] = $_GET['id_tournoi'];
    ...
    <div class="container bg-primary-gradient py-5">
      <div class="row">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
          ...
          <h3 class="fw-bold text-success mb-2">Demandes d'inscription</h3>
        </div>
      </div>
      ...
      <div class="card shadow-sm">
        <div class="card-body px-4 py-5 px-md-5">
          ...
          <form action="afficher_equipe_tournoi.php" class="p-3 p-xl-4" method="post">
            <table>
              <tbody>
                <tr>
                  <td>
                    <ul>
                      <p class="fw-bold text-success mb-2">Choisissez l'inscription que vous souhaitez valider</hp>
                        <select name="FK_ID_Equipe" id="listeIdTournoi" onchange="affichageSelect()">
                          <?php selectionner_noms_equipes_pas_inscrites_with_id(null, $_SESSION['id_tournoi_inscription']); ?>
                        </select>
                      <div id="concat"></div>
                      <!--
                                            <?php selectionner_demandes_noms_equipes_inscrites($_SESSION['id_inscription']); ?>
                          </br></br>

                        </select>
                      <div><button class="btn btn-primary " type="submit" name="submit" value="choix">OK</button></div>
 -->
        </div>
      </div>
      </ul>
      ...
      <table>
        <tbody>
          <tr>
            <td>
              <ul>
                <div><button class="btn btn-primary" type="submit" name="submit" value="modifier">Valider</button></div>

                <br /><br />
                <div><button class="btn btn-primary shadow d-block w-100" type="submit" name="submit" value="afficher">Toutes les demandes</button></div>
                <br /><br />
                ...
                if ($_POST['submit'] == "afficher") {
                  ...
                  afficher_toutes_demandes_inscrites();
                }
